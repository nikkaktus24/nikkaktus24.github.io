...
export default class ChooseFigure extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      attempts: 2
  ...
  render() {
    return (
      <div className="choose-figure">
        ...
        <p>Для продолжения игры тебе нужно выбрать название фигуры. Если ты пропустишь задачу, тогда будет ход врага.</p>
        <div className="choose-figure-condition"><img src={this.state.task.source.condition} /></div>
        <ul ref={this.list} onClick={this.onClickVariant} className="choose-figure-variants">
