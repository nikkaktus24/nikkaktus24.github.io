...
export default class Translator extends React.Component {
  ...
  compare(value, answer) {
    return includes(answer, value.toLowerCase());
  }
  ...
  render() {
    return (
      <div className="translator">
        ...
        <p>Для продолжения игры тебе нужно перевести слово. Если ты пропустишь задачу, тогда будет ход врага.</p>
        <form onSubmit={this.check.bind(this)} className="translator-form">
          <div className="translator-form-english-word">{this.state.task.source}</div>
